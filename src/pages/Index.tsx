                    ...
                    <div className="grid items-center gap-8 grid-cols-1 lg:grid-cols-2">
                        <div className="space-y-4">
                            ...
                            <div className={"flex flex-row gap-3"}>
                                <Button className={"rounded-2xl text-emerald-700 border-emerald-700 hover:bg-emerald-50 hover:text-emerald-700"} variant={"outline"} >
                                    <Link to={"https://simkah4.kemenag.go.id/"}>
                                        Daftar Nikah (SIMKAH)
                                    </Link>
                                </Button>

                                <Button className={"rounded-2xl text-emerald-50 bg-emerald-700 hover:bg-emerald-900 hover:text-emerald-50"} >
