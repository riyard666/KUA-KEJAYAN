...
export default function Kontak() {
    return(
        <>
            <Helmet>
                <title>Kontak KUA Kejayan - KUA Kejayan</title>
                <meta name="description" content="Kami siap membantu Anda. Silakan hubungi kami melalui detail di bawah ini atau kirimkan pesan melalui formulir kritik/saran." />
            </Helmet>
