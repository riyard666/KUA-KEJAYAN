...
export default function NewsList() {
    return (
        <>
            <Helmet>
                <title>Informasi KUA Kejayan - KUA Kejayan</title>
                <meta name="description" content="Dapatkan berita, pengumuman, dan informasi penting terkini yang selalu kami update untuk masyarakat." />
            </Helmet>
